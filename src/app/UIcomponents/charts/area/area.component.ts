...
export class AreaComponent {
  ...
  splineAreaChart: Partial<ChartOptions> = {
    chart: {
      toolbar: {
        show: false,
      },
  ...
  githubmMonthAreaChart: Partial<ChartOptions> = {
    chart: {
      height: 175,
      type: 'area',
      toolbar: {
  ...
  githubmYearAreaChart: Partial<ChartOptions> = {
    chart: {
      id: 'chartyear',
      type: 'area',
      height: 200,
  ...
  timeSeriesChart: Partial<ChartOptions> = {
    chart: {
      type: 'area',
      stacked: false,
      height: 380,
  ...
  nullvaluesChart: Partial<ChartOptions> = {
    chart: {
      toolbar: {
        show: false,
      },
