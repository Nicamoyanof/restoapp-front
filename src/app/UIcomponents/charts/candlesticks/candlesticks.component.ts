...
export class CandlesticksComponent {
  ...
  comboChart: Partial<ChartOptions> = {
    chart: {
      height: 240,
      type: 'candlestick',
      toolbar: {
  ...
  combobarChart: Partial<ChartOptions> = {
    chart: {
      height: 160,
      type: 'bar',
      toolbar: {
  ...
  xaxiscandlestickChart: Partial<ChartOptions> = {
    series: [
      {
        name: 'candle',
        data: [
  ...
  linecandlestickChart: Partial<ChartOptions> = {
    series: [
      {
        name: 'Line',
        type: 'line',
