...
export class ColumnComponent {
  ...
  distributedChart: Partial<ChartOptions> = {
    ...
    colors: [
      '#1e84c4', '#53389f', '#7f56da', '#ff86c8', '#ed5565', '#23c6c8', '#f9b931', '#1bb394'
    ],
    plotOptions: {
      bar: {
        columnWidth: '45%',
