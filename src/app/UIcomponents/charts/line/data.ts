...
export const simpleLineChartOpts: Partial<ChartOptions> = {
  chart: {
    height: 380,
    type: 'line',
    zoom: {
...
export const lineWithDataChartOpts: Partial<ChartOptions> = {
  chart: {
    height: 380,
    type: 'line',
    zoom: {
...
export const zoomableTimeseriesChartOpts: Partial<ChartOptions> = {
  chart: {
    type: 'area',
    stacked: false,
    height: 380,
...
export const annotationsChartOpts: Partial<ChartOptions> = {
  series: [
    {
...
export const syncingChartOpts: Partial<ChartOptions> = {
  chart: {
    height: 200,
    type: 'line',
    // id: 'yt',
...
export const syncingChartOpts2: Partial<ChartOptions> = {
  chart: {
    type: 'line',
    height: 160,
    // id: 'fb',
...
export const gradientLineChartOpts: Partial<ChartOptions> = {
  series: [
    {
      name: 'Sales',
...
export const missingNullValuesChartOpts: Partial<ChartOptions> = {
  chart: {
    height: 380,
    type: 'line',
    zoom: {
...
export const dashedLineChartOpts: Partial<ChartOptions> = {
  chart: {
    height: 380,
    type: 'line',
    zoom: {
...
export const stepLineChartOpts: Partial<ChartOptions> = {
  chart: {
    type: 'line',
    height: 344,
    zoom: {
...
export const brushChartOpts: Partial<ChartOptions> = {
  series: [
    {
      data: data,
    },
...
export const brushChartOpts2: Partial<ChartOptions> = {
  series: [
    {
      data: data,
    },
