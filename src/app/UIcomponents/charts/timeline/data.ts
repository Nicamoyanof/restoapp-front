...
export const basicTimelineChartOpts: Partial<ChartOptions> = {
  series: [
    {
      data: [
        {
...
export const distributedTimelineChartOpts: Partial<ChartOptions> = {
  series: [
    {
      data: [
        {
...
export const multiSeriesTimelineChartOpts: Partial<ChartOptions> = {
  series: [
    {
      name: 'Bob',
      data: [
...
export const advancedTimelineChartOpts: Partial<ChartOptions> = {
  series: [
    {
      name: 'Bob',
      data: [
...
export const groupTimelineChartOpts: Partial<ChartOptions> = {
  series: [
    // George Washington
    {
